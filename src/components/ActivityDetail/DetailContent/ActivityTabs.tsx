...
export default function ActivityTabs(props: ActivityHeaderProps) {
  ...
  return (
    <div className="dark-base sticky top-70 z-10 hidden h-70 w-full border-y-1 border-custom-gray-200 bg-white transition-all duration-500 dark:border-custom-black md:block">
