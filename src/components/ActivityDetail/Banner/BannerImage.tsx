      ...
      {subImageUrl && subImageUrl.length === 0 ? (
        ...
        >
          ...
          <button
            ...
            className="dark-base absolute bottom-20 right-20 h-40 w-120 rounded-3xl border border-custom-gray-400 bg-white text-md-regular transition hover:bg-custom-gray-800 hover:text-white dark:hover:bg-white dark:hover:text-custom-gray-700"
          >
            사진 전체 보기
          </button>
