...
export function PrevButton() {
  ...
  return (
    <button
      ...
      disabled={disabled}
      aria-label="prev"
      className="dark-border flex-center size-40 rounded-[15px] border border-custom-green-200 bg-white hover:bg-gray-100 disabled:cursor-not-allowed disabled:border-custom-gray-300 disabled:hover:bg-white dark:bg-custom-black dark:text-white dark:hover:bg-custom-black md:size-55"
...
function PageItem({ page }: { page: number }) {
  ...
  const classnames = classNames(
    'flex-center rounded-[15px] size-40 md:size-55 dark:bg-custom-black dark:text-white dark-border',
    {
      'bg-custom-green-200 dark:bg-custom-green-200 text-white hover:bg-[#0b553e]':
        currentPage === page,
      'bg-white hover:bg-gray-100 dark:hover:bg-[#0b553e] border border-custom-green-200':
        currentPage !== page,
    },
  );
