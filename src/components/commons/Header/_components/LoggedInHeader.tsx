      ...
      >
        ...
        {isProfileBoxVisible && (
          ...
          >
            ...
            <Link href="/mypage">
              <p className="rounded-md p-4 text-center text-md-medium transition-all hover:bg-custom-gray-300 dark:hover:bg-custom-black">
                마이페이지
              </p>
            </Link>
            <hr className="my-2 border border-gray-200" />
            <p
              className="rounded-md p-4 text-center text-md-medium transition-all hover:bg-custom-gray-300 dark:hover:bg-custom-black"
              onClick={logout}
            >
              로그아웃
            </p>
