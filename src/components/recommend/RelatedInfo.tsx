...
export default function RelatedInfo({ data }: Props) {
  return (
    <>
      <h1 className="mt-200 block text-28 font-bold text-nomad-black md:text-32 xl:mt-[400px] xl:text-40">
        관련 행사
      </h1>
      ...
      <div className="mb-200 mt-20 flex gap-16 overflow-x-auto xl:gap-32">
        {data.map((each) => (
          ...
          >
            ...
            <div className="flex h-120 flex-col rounded-b-xl bg-custom-gray-200 px-8 py-12 text-14">
